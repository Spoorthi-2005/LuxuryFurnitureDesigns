                  ...
                  <div className="p-12">
                    ...
                    <div className="bg-gradient-to-r from-gold/15 to-gold/5 p-8 rounded-xl border border-gold/50 shadow-2xl">
                      <div className="space-y-10">
                        <div>
                          <span className="block text-lg font-playfair font-bold text-gold mb-2 tracking-wider uppercase">
                            FOUNDER & CREATIVE DIRECTOR
                          </span>
                          <span className="block text-3xl font-playfair font-bold text-white mb-6 tracking-wide">
                            AMAR CHAUHAN
                          </span>
